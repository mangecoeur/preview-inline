...
import {mathBlockScopes, mathInlineScopes, imageScopes, citationScopes} from './previewScopes';

let EditorPreviewMarkerViews = new WeakMap();

// TODO: show all image or math previews for current document
// TODO: make right click menu context sensitiv, only show preview command inside accepted scopes
// see https://discuss.atom.io/t/context-sensitive-context-menu/19573/2
...
export default {
  ...
  shouldDisplayContextMenu(event) {
    ...
    if (editor) {
      let allScopes = [...mathBlockScopes, ...mathInlineScopes, ...imageScopes];
